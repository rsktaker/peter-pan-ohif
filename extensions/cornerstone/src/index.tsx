...
// Side-effect: registers a metaData provider that strips bogus narrow-window
// VOI and -1024 rescale on Secondary Capture dose-report screens.
import './tools/SecondaryCaptureVOIFixProvider';
